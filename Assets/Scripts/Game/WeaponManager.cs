            ...
            else if (!isDamageFinished && ScreenWeapon.GetCurrentFrame() == ScreenWeapon.GetHitFrame())
            {
                ...
                else
                {
                    ...
                    if (missile)
                    {
                        ...
                        DaggerfallUnityItem arrow = playerItems.GetItemEx(ItemGroups.Weapons, (int)Weapons.Arrow, ItemCollection.Filter.QuestDenied, ItemCollection.Priority.Conjured);

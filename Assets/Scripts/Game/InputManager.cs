...
namespace DaggerfallWorkshop.Game
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        public KeyCode GetAnyKeyDown(bool includeModifierKeys = false)
        {
            foreach (KeyCode k in KeyCodeList)
                if ((includeModifierKeys || !unacceptedAnyKeys.Contains((int)k))
        ...
        public KeyCode GetAnyKeyUp(bool includeModifierKeys = false)
        {
            foreach (KeyCode k in KeyCodeList)
                if ((includeModifierKeys || !unacceptedAnyKeys.Contains((int)k))
        ...
        public KeyCode GetAnyKeyDownIgnoreAxisBinds(bool includeModifierKeys = false)
        {
            foreach (KeyCode k in KeyCodeList)
                if ((includeModifierKeys || !unacceptedAnyKeys.Contains((int)k))
        ...
        public KeyCode GetAnyKeyUpIgnoreAxisBinds(bool includeModifierKeys = false)
        {
            foreach (KeyCode k in KeyCodeList)
                if ((includeModifierKeys || !unacceptedAnyKeys.Contains((int)k))
                    && !IsUsedInAxisBinding(k)
